...
public class MobileNetworkSettings extends PreferenceActivity
    ...
    protected void onCreate(Bundle icicle) {
        ...
        try {
            ...
            //Infinix:add by sujianze  2017/7/19 begin
            //mShow4GForLTE = con.getResources().getBoolean(id);
            mShow4GForLTE = SystemProperties.get("ro.boot.opt_lte_support").equals("1");
            //Infinix:add by sujianze 2017/7/19 end
        ...
        if (preference == mButtonPreferredNetworkMode) {
            ...
            if (buttonNetworkMode != settingsNetworkMode) {
                ...
                switch (buttonNetworkMode) {
                    case Phone.NT_MODE_WCDMA_PREF:
                    case Phone.NT_MODE_GSM_ONLY:
                    case Phone.NT_MODE_WCDMA_ONLY: //Infinix:add by sujianze 2017/7/19
                    case Phone.NT_MODE_LTE_GSM_WCDMA:
                    case Phone.NT_MODE_LTE_CDMA_EVDO_GSM_WCDMA:
                    case Phone.NT_MODE_CDMA:
                    case Phone.NT_MODE_CDMA_NO_EVDO:
        ...
        switch (NetworkMode) {
            ...
            case Phone.NT_MODE_WCDMA_PREF:
                if (!mIsGlobalCdma) {
                    ...
                    mButtonEnabledNetworks.setSummary(R.string.network_3G_2G);//Infinix:modify by sujianze 2017/7/19
                } else {
                    mButtonEnabledNetworks.setValue(
            ...
            case Phone.NT_MODE_LTE_GSM_WCDMA:
                ...
                mButtonEnabledNetworks.setSummary(R.string.network_4G_3G_2G);
                break;
                //Infinix:add by sujianze 2017/7/19 end
            case Phone.NT_MODE_LTE_ONLY:
                //Infinix:add by sujianze 2017/7/19 begin
                mButtonEnabledNetworks.setValue(Integer.toString(Phone.NT_MODE_LTE_ONLY));
            ...
            case Phone.NT_MODE_LTE_WCDMA:
                if (!mIsGlobalCdma) {
                    ...
                    mButtonEnabledNetworks.setSummary((mShow4GForLTE == true)
                            ? R.string.network_4G_only : R.string.network_lte);//Infinix:modify by sujianze 2017/7/19
                } else {
                    mButtonEnabledNetworks.setValue(
                            Integer.toString(Phone.NT_MODE_LTE_CDMA_EVDO_GSM_WCDMA));
                    mButtonEnabledNetworks.setSummary(R.string.network_global);
